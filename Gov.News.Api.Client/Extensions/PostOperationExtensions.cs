...
namespace Gov.News.Api
{
    ...
    public static partial class PostOperationExtensions
    {
        ...
        /// The operations group for this extension method.
        /// </param>
        public static IEnumerable<Post> GetMorePostsNoVersion(this IPostOperations operations, string postType, string kind, string key, int count, int skip)
        {
            return System.Threading.Tasks.Task.Factory.StartNew(s => ((IPostOperations)s).GetMorePostsNoVersionAsync(postType, kind, key, count, skip), operations, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskCreationOptions.None, System.Threading.Tasks.TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async System.Threading.Tasks.Task<IEnumerable<Post>> GetMorePostsNoVersionAsync(this IPostOperations operations, string postType, string kind, string key, int count, int skip, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            using (var _result = await operations.GetMorePostsWithHttpMessagesAsync(ClientExtensions.currentAPIVersion, postType, kind, key, count, skip, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
